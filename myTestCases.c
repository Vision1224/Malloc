...
int main() 
{
  ...
  /*test case # 1*/
  p18= resizeRegion(p1,131033);//will fail
  /*test case # 2*/
  p18= resizeRegion(p1,131016);//will pass  
  
  /*test case # */
  p18= resizeRegion(p1,131008);

  /*test case # */
  p18= resizeRegion(p1,131008);
  printf("**JUST FINISHED RESIZING REGIONS NOW WILL ALLOC AGAIN***\n\n ");
  printBlockInfo();
  arenaCheck();
  printf("\n\n\n");
